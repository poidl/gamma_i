...
nsx = nan*ones(nz,ny,nx); nsy = nsx;

s_east = nan*ones(nz,1); t_east = s_east; g_east = s_east; p_east = s_east;
s_west = nan*ones(nz,1); t_west = s_west; g_west = s_west; p_west = s_west;
s_north = nan*ones(nz,1); t_north = s_north; g_north = s_north; p_north = s_north;
s_south = nan*ones(nz,1); t_south = s_south; g_south = s_south; p_south = s_south;
...
for j0 = 2:ny-1
    ...
    for i0 = 2:nx-1
        ...
        if ocean(j0,i0)>=1 & ocean(j0,i0)<=7 & ...
            ...
            for k0 = 1:n(j0,i0)
                if p(k0,j0,i0)>=plevel & g(k0,j0,i0)>=0
                    [sns_e(k0),tns_e(k0),pns_e(k0),dsns,dtns,dpns] = ...
                        neutral_surfaces0(s_east(1:n_east),t_east(1:n_east),p_east(1:n_east), ...
                        g_east(1:n_east),g(k0,j0,i0));
                    [sns_w(k0),tns_w(k0),pns_w(k0),dsns,dtns,dpns] = ...
                        neutral_surfaces0(s_west(1:n_west),t_west(1:n_west),p_west(1:n_west), ...
                        g_west(1:n_west),g(k0,j0,i0));
                    [sns_n(k0),tns_n(k0),pns_n(k0),dsns,dtns,dpns] = ...
                        neutral_surfaces0(s_north(1:n_north),t_north(1:n_north),p_north(1:n_north), ...
                        g_north(1:n_north),g(k0,j0,i0));
                    [sns_s(k0),tns_s(k0),pns_s(k0),dsns,dtns,dpns] = ...
                        neutral_surfaces0(s_south(1:n_south),t_south(1:n_south),p_south(1:n_south), ...
