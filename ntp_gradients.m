...
s_east = nan*ones(nz,1); t_east = s_east; p_east = s_east;
s_west = nan*ones(nz,1); t_west = s_west; p_west = s_west;
s_north = nan*ones(nz,1); t_north = s_north; p_north = s_north;
s_south = nan*ones(nz,1); t_south = s_south; p_south = s_south;
