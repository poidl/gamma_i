...
if(icalled_from_driver.eq.0) then
  open(10,file='d:/neutrals/ness7/an_equation/rfunc_21_0.dat',status='old')
  read(10,*) a
  close(10)
...
gamma = gamma + a(16)*ss**5.d0+a(17)*ss**4.d0*tt+a(18)*ss**3.d0*tt**2.d0 +          &
		   a(19)*ss**2.d0*tt**3.d0+a(20)*ss*tt**4.d0+a(21)*tt**5.d0
