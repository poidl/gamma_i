function [k_north, r_north] = gamma_intersections_north(SA,CT,p,ocean,n)
...
%             lat0 = lat(j0,i0);
            ...
            if isfinite(SA(1,j0_north,i0))
                ...
                for k0 = 1:n0
                    try
                        k_north(k0,j0,i0) = gamma_indx(p(1:n0_north,j0_north,i0),pdns_north(k0));
