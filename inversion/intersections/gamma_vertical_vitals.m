function [k_vert,r_vert,gprod_vert,no_eqs] = gamma_vertical_vitals(SA,CT,p,gamma,n,r_north,r_east,r_south,r_west,handles)
...
for kg = 1:ng
    ...
    if nr(kg) >= 1
        %This needs fixing so the first (shallowest) bottle does not have 
        %to be at the sea surface. It will be a simple indexing problem.
