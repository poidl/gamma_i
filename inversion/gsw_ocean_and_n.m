function [ocean, n] = gsw_ocean_and_n(SA,CT,p,long,lat)
...
%
% USAGE:  
%  ocean = gsw_ocean_3d(longs,lats,z)
%
% DESCRIPTION:
%  gsw_ocean_3d      ocean of longs/lats observations
%
% INPUT: 
...
%           6    South Atlantic
%           7    Atlantic / Artic
%           8    Artic, mediterranean sea
%           9    Red Sea, persian gulf, Red Sea, baltic sea
%           10   black/caspian seas, African lakes
% Author:    	
...
function ocean = gsw_ocean_2d(long,lat)

% gsw_ocean_2d
%==========================================================================
%
% USAGE:  
%  ocean = dj_ocean0(long,lat)
%
